...
Publisher.create!([
  {name: 'Wiley'}, {name: 'Addison Wesley'},
  {name: 'Peachpit Press'}, {name: 'Manning'},
  {name: 'McGraw-Hill'},{name: 'No Start Press'}])
...
Book.create!(title: 'Gnuplot in Action', isbn: '9781933988399',
  page_count: 360, price: 66.37, description: 'A book on the awesome opensource
  plotting software', published_at: '2010-11-04', publisher_id: 4,
...
Book.create!(title: 'Practical Database Programming with Java', isbn: '9780470889404',
  ...
  and applications in database programming using Java Netbeans IDE, JSP, JSF,
  and Java Beans', published_at: '2011-11-04', publisher_id: 1,
  book_cover: File.open(File.join(Rails.root, 'app/assets/images/practical_db.jpg')))

Book.create!(title: 'iText in Action', isbn: '9781935182610', page_count: 585,
  price: 59.99, description: 'This opensource Java library has been the most
  popular and most broadly used tool for programmatic creation and manipulation of PDF',
...
Book.create!(title: 'The Art of R Programming', isbn: '9781593273842',
  page_count: 373, price: 39.95, description: 'This book takes you on a guided
  tour of software development wih R, from basic types and data structures to
  advanced topics like closures, recursion and anonymous functions',
  published_at: '2011-11-04', publisher_id: 6,
  book_cover: File.open(File.join(Rails.root, 'app/assets/images/art_of_r.jpg')))

Book.create!(title: 'Introduction to Object-oriented Analysis and Design with UML
  and Unified Process', isbn: '0071215107', page_count: 395, price: 49.99,
  description: 'It introduces the object-oriented systems analysis and design',
  published_at: '2004-08-25', publisher_id: 5,
  book_cover: File.open(File.join(Rails.root, 'app/assets/images/ooa_design.jpg')))


#  User.create(email:'nasro@example.com', first_name:'Nasser', last_name:'Kahil', password:'naspass', admin: true)
